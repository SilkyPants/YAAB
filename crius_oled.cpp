...
//
//
void crius_oled::drawChar( uint16_t x, uint16_t y, unsigned char character )
{
...
//
//
void crius_oled::drawString( uint16_t x, uint16_t y, unsigned char * string )
{
	uint8_t charWidth = SmallFont[5];
...
void crius_oled::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1) 
{
