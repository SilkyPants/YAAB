...
+------------------------+-----------+-----------+-----------+   |
| Pneumatic Off    (POFF)|    20ms   |    24ms   |   199ms   |---+
+------------------------+-----------+-----------+-----------+
| Eye Timeout      (EOUT)|    0.1s   |    1.0s   |   19.9s   |---+
+------------------------+-----------+-----------+-----------+   |
| Eye Ball Detect  (BALD)|     1ms   |     1ms   |   19ms    |   |
+------------------------+-----------+-----------+-----------+   |
| Eye Seen         (ESEE)|           |           |           |   +---> Eye Settings
+------------------------+-----------+-----------+-----------+   |
| Eye Empty See  (EMPSEE)|           |           |           |   |
+------------------------+-----------+-----------+-----------+   |
...
{
    uint8_t profileNameIndex;         // Name for the profile
